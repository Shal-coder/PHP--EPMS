...
<head>
    ...
    <title>Add User | PayrollPro Admin</title>
            ...
            <main class="main">
                ...
                <div class="form-card">
                    <form method="POST">
                        ...
                        <div class="form-group"><label>Password</label><input type="password" name="password" placeholder="Leave blank for default (password123)"></div>
                        <div class="form-group"><label>Role *</label><select name="role" required><option value="employee">Employee</option><option value="manager">Manager</option><option value="super_admin">Super Admin</option></select></div>
