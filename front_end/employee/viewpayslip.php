<?php
/**
 * View Payslip Details - Employee
 * Employees can view their individual payslip
 */
...
// Get payslip item - ensure it belongs to this employee
$stmt = Database::query(
...
<head>
    ...
    <title>Payslip Details | PayrollPro</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-print { padding: 10px 20px; background: linear-gradient(135deg, #06b6d4, #0891b2); color: #fff; text-decoration: none; border-radius: 8px; font-weight: 600; display: inline-block; margin-left: 10px; border: none; cursor: pointer; }
        ...
        .payslip-header h2 { font-size: 32px; font-weight: 800; color: #67e8f9; margin-bottom: 8px; }
        ...
        .breakdown-section h3 { font-size: 16px; font-weight: 700; color: #67e8f9; margin-bottom: 16px; text-transform: uppercase; }
        ...
        .summary-section { background: rgba(6,182,212,.08); border: 1px solid rgba(6,182,212,.2); border-radius: 14px; padding: 24px; }
        .summary-row { display: flex; justify-content: space-between; padding: 12px 0; font-size: 16px; }
        .summary-row.total { border-top: 2px solid rgba(6,182,212,.3); margin-top: 12px; padding-top: 16px; }
        .summary-row.total .label { font-size: 20px; font-weight: 800; color: #67e8f9; }
        .summary-row.total .value { font-size: 24px; font-weight: 800; color: #67e8f9; }
        ...
        <div class="layout">
            ...
            <main class="main">
                <div class="page-header">
                    ...
                    <div>
                        <a href="payroll.php" class="btn-back">← Back</a>
                ...
                <div class="payslip-container">
                    ...
                    <div class="breakdown-section">
                        ...
                        <div class="breakdown-item" style="background:rgba(6,182,212,.08);margin-top:8px;">
