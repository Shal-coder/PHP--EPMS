<?php
/**
 * Manager Salary & Payroll Page
 * Managers can view their own salary breakdown and payslips
 */
...
if (!$employee) {
    die('Employee profile not found. Please contact admin to set up your salary profile.');
}
...
<head>
    ...
    <title>My Salary | PayrollPro Manager</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .breakdown-card h4 { font-size: 14px; color: #c4b5fd; text-transform: uppercase; letter-spacing: .05em; font-weight: 700; margin-bottom: 16px; }
        ...
        .breakdown-total { background: rgba(139,92,246,.05); margin: 12px -12px -12px; padding: 12px; border-radius: 0 0 14px 14px; display: flex; justify-content: space-between; font-weight: 700; }
        .item-badge { padding: 2px 6px; border-radius: 4px; font-size: 10px; font-weight: 600; background: rgba(139,92,246,.15); color: #c4b5fd; margin-left: 6px; }
        ...
        .amount.net { color: #c4b5fd; font-size: 16px; }
        ...
        .action-btn { padding: 6px 12px; border-radius: 6px; font-size: 12px; font-weight: 600; text-decoration: none; background: rgba(139,92,246,.15); color: #c4b5fd; transition: all .2s; }
        .action-btn:hover { background: rgba(139,92,246,.25); }
        ...
        <div class="layout">
            <aside class="sidenav">
                ...
                <nav>
                    ...
                    <a class="nav-link active" href="salary.php"><span class="nav-icon">💵</span> My Salary</a>
            ...
            <main class="main">
                <div class="page-header">
                    <h1>💵 My Salary & Payroll</h1>
                    <p class="lede">Your personal salary breakdown and payslip history</p>
                </div>
                ...
                <div style="background: rgba(139,92,246,.08); border: 1px solid rgba(139,92,246,.2); border-radius: 14px; padding: 20px; margin-bottom: 28px; display: flex; justify-content: space-between; align-items: center;">
                    <div>
                        <p style="color: #9fb4c7; font-size: 13px; margin-bottom: 4px;">Estimated Net Salary (Before Tax)</p>
                        <p style="color: #c4b5fd; font-size: 24px; font-weight: 800;">$<?= number_format($estimatedNet, 2) ?></p>
                    </div>
                ...
                <h3 class="section-title">My Payslip History</h3>
